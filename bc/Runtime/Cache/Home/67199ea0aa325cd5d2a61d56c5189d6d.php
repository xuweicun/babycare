...
<div id="layout-container"  style="height:auto;" class="container">
 <div class="row">
        <div class="col-md-12">
          <ul class="breadcrumb">
            <li><a href="/index.php/Home/Bestforbaby">物品管理<span class="glyphicon glyphicon-tag"></span></a>
              <span class="divider">&raquo;</span></li>
            <li><a>增加物品</a></li>
          </ul>
          <form class="form-horizontal" name="form1" id="form" role="form" method="post" action="/index.php/Home/Bestforbaby/<?php echo ($action); ?>" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <div class="col-md-10 col-lg-10">
                ...
                <p class="help-block">如需更改品牌，请<a href="/index.php/Home/Bestforbaby/<?php echo ($action); ?>">重新选择</a></p>
              </div>
            </div>
            ...
            <?php switch($action): case "insertitem": ?><div class="form-group"><?php break;?>
                <?php case "edititem": ?><div class="form-group" id="ctgrZone" style="display:none;"><?php break;?>
                <?php default: ?><div class="form-group"><?php endswitch;?>
                ...
                <div class="btn-group">
                  ...
                  <ul role="menu" class="dropdown-menu">
                    <?php if(is_array($category)): foreach($category as $key=>$t): ?><li>
                      ...
                      <?php else: ?>
                      <a onClick="javascript:selectDropDown(this,'<?php echo ($t["name"]); ?>','select-btn1');ajaxListChildren('ctgr-select','<?php echo ($ctgrURL); ?>'+<?php echo ($t["category_id"]); ?>);"><?php echo ($t['name']); ?></a></li><?php endif; ?>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" class="form-control tagsinput validate[required]" id="name" placeholder="名称" name="name" value="<?php echo (stripslashes($brand["cn_name"])); ?>, <?php echo (stripslashes($brand["name"])); ?>">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-lg-10">
                ...
                <p class="help"><?php if(!empty($existingVersion)): ?>已有版本：
                  <?php if(is_array($existingVersion)): foreach($existingVersion as $key=>$t): ?><a href="/index.php/Home/Bestforbaby/viewitem/id/<?php echo ($t["id"]); ?>" class="btn btn-mini btn-alert" type="button"><?php echo ((isset($t["version"]) && ($t["version"] !== ""))?($t["version"]):"默认版本"); ?></a><?php endforeach; endif; endif; ?></p>
              </div>
             ...
             <div class="form-group">
               ...
               <div class="input-group col-lg-10" id="img">
                  ...
                  <span class="input-group-btn">
                    <button class="btn btn-default" type="button" onclick="window.open('/index.php/Home/Bestforbaby/innerupload/formname/form1/editname/img','图片上传','left=300px,height=400,width=500');">上传图片</button>
                  </span>
               </div><!-- /input-group -->
             </div>
             <div class="form-group">
