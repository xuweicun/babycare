...
<link href="/Public/lw_assets/css/style.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="/Public/assets/script/lhgdialog/lhgdialog.js?skin=idialog"></script>
<script type="text/javascript" src="/Public/assets/script/layout.js"></script>
                    ...
                    <ul>
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a navid="user_lists" href="/index.php/Home/brand/viewitems" target="mainframe" class="item">
                                        <span>查看品牌</span>
                                    </a>
                                </li>
                            </ul>
                            ...
                            <ul>
                                <li>
                                    <a navid="admin_add" href="/index.php/Home/company/viewitems" target="mainframe" class="item">
                                        <span>查看厂商</span>
                                    </a>
                                </li>
                            </ul>
                            <ul>
                                <li>
                                    <a navid="admin_add" href="/index.php/Home/Instruction/viewtitles" target="mainframe" class="item">
                                        <span>管理标签</span>
                                    </a>
                                </li>
                            </ul>
