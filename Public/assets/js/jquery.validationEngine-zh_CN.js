		...
		newLang:function(){
			$.validationEngineLanguage.allRules = {
				...
				"qq":{
				 ...
				 'ajaxName': { 
      			'url': '/index.php/home/brand/checkName', /* 验证程序地址 */ 
      			'extraData': '', /* 额外参数 */ 
      			'alertTextOk': '此名称是唯一的', 
      			'alertText': '已经有这样的品牌了', 
     			'alertTextLoad': '正在验证是否有重复品牌' 
     			},
				'viewName':{
                  'url': '/index.php/home/bestforbaby/checkViewName', /* 验证程序地址 */ 
                  'extraData': '', /* 额外参数 */ 
                  'alertTextOk': '验证通过', 
                  'alertText': '已存在', 
                 'alertTextLoad': '正在验证是否有重复'   
                },
                'sizeName':{
                  'url': '/index.php/home/bestforbaby/checkSizeName', /* 验证程序地址 */ 
                  'extraData': '', /* 额外参数 */ 
                  'alertTextOk': '验证通过', 
                  'alertText': '已存在', 
                 'alertTextLoad': '正在验证是否有重复'   
