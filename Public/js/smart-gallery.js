    ...
    $.fn.extend({
        gallery: function(options) {
            ...
            return this.each(function() {
                ...
                shortcontainer = $('<div/>').css('display', 'none').addClass('short');
                longcontainer = $('<div/>').addClass('long');
                ...
                function fade() {
                    images.removeClass('previous');
                    currentImage.css({ 'z-index': '101', opacity: 0,'display':'' });
                    if (previousImage != null) {
                            previousImage.toggle(settings.animationspeed);//css({'z-index': '98','display':'none'});
                        }
